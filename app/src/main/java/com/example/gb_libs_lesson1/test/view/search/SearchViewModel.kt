...
import com.example.gb_libs_lesson1.test.presenter.search.SearchSchedulerProvider
...
import com.example.gb_libs_lesson1.test.view.search.MainTestActivity.Companion.BASE_URL
...
class SearchViewModel(
    ...
    fun searchGitHubwithCoroutine(searchQuery: String) {
