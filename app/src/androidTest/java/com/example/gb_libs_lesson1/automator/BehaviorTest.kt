package com.example.gb_libs_lesson1.automator
...
//            .perform(ViewActions.pressImeActionButton())
        ...
        val searchButton = uiDevice.findObject(By.res(packageName, "searchButtonTestMA"))
        searchButton.click()
